...
This SDK is deprecated as of July 13, 2023 and will no longer be maintained or supported.

We recommend migrating to our new [Vault SDK for Android](https://central.sonatype.com/artifact/com.mangopay.android/vault) instead. The new SDK provides the same functionality of [card registration flow](https://mangopay.com/docs/endpoints/direct-card-payins#card-registration-object), with Kotlin language support., better performance, and continued support.

For details on migrating from this SDK to the new Swift SDK, see our [migration guide](https://mangopay.com/docs/sdk/vault-android). 

If you have any other questions around this deprecation, please open an issue on this repo.

This SDK will be archived on January 1, 2024. Please migrate before then to avoid any disruptions. We appreciate your understanding!
